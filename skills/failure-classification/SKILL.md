...
description: Classifies test failures into FE Code, BE Code, QA Automation, CI/Config, Flaky, or Chronic categories with confidence levels and root cause analysis. Use when assigning a classification to a triaged failure.
---
...
1. Identify the **sprint trigger** — the most recent commit that caused this failure to appear now (use git-correlation skill)
