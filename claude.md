...
| `config-setup-inversion` | Setup step named Enabled/Disabled sends wrong boolean to config API | ✓ 2026-03-13 |
| `admin-session-cookie-survival` | Admin session cookie survives user switch causing wrong login state | ✓ 2026-03-14 |
